...
1. **锚机构 + 开放接口**（Kendall、云栖、Adlershof）：海淀的高校与平台企业是「锚」，但锚的价值取决于开放接口——共享测试场、开源发布厅、公共数据沙盒让中小团队与独立开发者能接入生态，而非只被龙头辐射。其中公共数据沙盒属于数据要素流通的合规创新方向。据公开报道，北京市已发布公共数据授权运营相关管理办法（如《北京市公共数据资源授权运营管理办法》等，以主管部门正式发布文件为准），具体条款与适用边界仍待官方一手来源核实；本方案据此将「沙盒」表述为「依托海淀区政府授权运营框架的合规试点（概念建议）」，保留概念建议属性与数据合规边界，不作为对已出台政策的确定引述（[source:POLICY-PUBLIC-DATA]，待核实）。
...
- 边界：配送验证区分两类——人行道低速机器人（与行人同速、共享人行空间）与道路上无人驾驶车辆（海淀已有官方指定自动驾驶测试道路[source:POLICY-HAIDIAN-AV]；另有据公开报道的中关村自动驾驶示范区建设消息[source:CASE-HAIDIAN-AV-ZONE，待核实]，其范围与面积以主管部门公布为准；均按测试道路机制申领路权试点许可）；展示内容须清权；不写成已批准运营
...
**南段「走读历史」（北京北站—清华园—学院南路，约3公里）**：以文脉线（铁锈红）为色彩主调。空间动作：①**人字形展线广场**——在遗址公园南段选取一处可停留节点，以詹天佑八达岭人字形展线为原型做地面铺装与座椅构图，形成「走读京张自主建造史」的起点；②**清华园车站记忆节点**——结合清华园车站旧址（据公开资料为文保对象，具体保护等级与保护范围以主管部门公布为准），组织「老站房-新导视」的对比阅读（仅做周边公共空间组织与导视建议，不触碰文保建筑本体）；③**枕木记忆座椅带**——以京张旧枕木意象设计连续座椅，间隔嵌入二维码铭牌，扫码阅读沿线历史与AI叙事（内容须清权，见第六节）。
...
- 空间位置：遗址公园南段、清华园车站旧址（1910年建；据公开资料为文保对象，具体保护等级待主管部门确认）周边公共空间（[data:geometry/key_areas.geojson#PROV-KEY-002]关联区、[source:CASE-QINGHUAYUAN-STATION]）
...
| 层级 | 资源 | 叙事价值 | 空间落位 |
| --- | --- | --- | --- |
| 实物遗产 | 清华园车站旧址（1910年建；据公开资料为文保对象，保护等级待确认） | 「自主建造」的第一站实物见证 | 遗址公园南段（L1道钉装置对话对象，[source:CASE-QINGHUAYUAN-STATION]） |
