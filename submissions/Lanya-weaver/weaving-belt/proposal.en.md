...
- Boundary: Delivery verification distinguishes two types — sidewalk-level slow robots (pedestrian speed, sharing pedestrian space) and road-based autonomous vehicles (Haidian's official designated autonomous driving test roads [source:POLICY-HAIDIAN-AV]; a 100 km² Zhongguancun autonomous driving demonstration zone announced by Haidian District in its Fifteen Measures Supporting Intelligent Connected Vehicle Innovation (May 2019) [source:CASE-HAIDIAN-AV-ZONE]; all requiring test road permits); display content requires rights clearance
...
- Spatial Location: South Ruins Park, public space around Qinghuayuan Station (built 1910; Beijing Municipal Heritage Protection Unit, Ninth Batch supplementary list, [source:CASE-QINGHUAYUAN-STATION])
