---
title: "City as Agent: Jing-Zhang Civic Interlocking A0-827 Expert Visual Edition"
...
summary: "Eight coordinated A0-827 boards connect the City as Agent proposition, corridor masterplan, Public Loop, three distinct civic nodes, continuous experience and implementation-exit closure to the same recalculable geometry, metrics and public-rights evidence layer."
...
**Reading route.** The A0 and A3 sets each contain the same eight bilingual boards: proposition, coordinated masterplan, Public Loop, north/middle/south nodes, continuous civic experience, and delivery-metrics-exit closure. This V13 is independent from V12 and all earlier submissions.

## Civic Interlocking as a Spatial Release Mechanism

“City as Agent” is neither software vocabulary pasted onto the city nor a proposal to hand the city to a super-AI. V13 turns the railway's engineering metaphor into urban design: railway interlocking prevents conflicting routes; **Civic Interlocking** permits visible AI shadow action only when five conditions align—public baseline, named human, rights and scope, legible evidence, and recovery readiness. This is not a claim to apply railway signalling technology or a safety certification. It makes “when the city must not act” visible in plan, section, signal state and responsibility contract. [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] [depth:overall_spatial_structure]
...
![Spatial structure of one public baseline, three task platforms and two interface wings](assets/figures/land-use-structure.en.png)
...
![Seven public rights by six user groups](assets/figures/public-acceptance.en.png)
...
![Health, education and commerce test contracts](assets/figures/scenario-operations.en.png)
...
This edition turns taskbook coverage into six handover contracts. Each names its spatial object, users, operator, evidence, stop condition and next professional owner. Institutional roles remain suggestions until authorised. [source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
...
![Reversible 3 m Information Platform section](assets/figures/information-platform-section.en.png)
...
![First 100 Days and RACI responsibility matrix](assets/figures/first-100-days.en.png)
...
Five risk classes remain publicly registered: `sources.json` and provisional labels control public-source boundaries; privacy protection uses an anonymous ordinary route, minimum data, withdrawal and deletion receipts; `report/copyright_statement.md` records the provenance and non-photographic status of the final P1-P8 concept visuals; implementation risk binds cost, owner, approval, operation and stop conditions at G0; and named professionals review health, education, commerce and public-service outputs. If any condition fails, the AI shadow bay returns to HOLD while ordinary service continues. [assumption:A-RENDER-001] [assumption:A-PERMIT-001]
