...
3. **复兴岛人机友好示范区导则（上海）**：双底座（通用无障碍 + 数字孪生）、五景五友好、六类机器人分类，以及“测试展示—入驻孵化—研发创新”产业路径与全流程影响评估 [source:CASE-FUXING-HMF-GUIDE]。
...
| 层级 | 内容 | 判断 |
|---|---|---|
| 可先行 | H0–H3 分级准入、机器身份与意图标识、人工替代、急停与接管、数据最小化、投诉闭环、众智园封闭测试 | 属制度与试点范畴，不依赖精确线位，可立即启动 |
| 需专项后可行 | H2 共行断面改造、站城无障碍接驳、清华园站 H0 静谧段 | 须先完成 P0 第1–4项，按实测断面重新设计 |
