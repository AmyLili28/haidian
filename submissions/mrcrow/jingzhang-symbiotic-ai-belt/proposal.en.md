...
![Evidence, problem, overall structure, and four connections](assets/figures/site-overview.en.png)
...
![Physical construction actions, status categories, and one-spine-three-core framework](assets/figures/land-use-structure.en.png)
