...
![Source evidence chain and package relationship](assets/figures/site-overview.png)
...
![Park commons: retained railway traces, complete slow mobility and a staffed public-service point](assets/renders/park-commons.png)
...
![Beijing AI Origin Community: adaptive reuse linking campus, neighborhood and technology transfer](assets/renders/origin-community.png)
...
![Physical-AI test yard: contained, transparent and reversible, with a clear separation from park users](assets/renders/test-yard.png)
...
![Dazhongsi everyday-adoption node: small launch market, rider-friendly service and separated pedestrian/logistics lanes](assets/renders/dazhongsi-market.png)
...
![Four-step build sequence: protect, connect, test, adopt, with construction grammar and evidence gates](assets/figures/build-sequence.en.png)
...
![Three typical interfaces: quiet heritage park, contained test edge and everyday-adoption forecourt](assets/figures/typical-sections.en.png)
...
![Future development path: verify, protect and connect, contained test, real-life adoption, scale or restore](assets/figures/future-development.en.png)
