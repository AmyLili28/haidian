---
title: "ZERO·JZ: Zero-Waste Loop — Zero-Waste City Practice Belt & Resource Circularity System (Concept)"
author_github: "JohnXu22786"
language: "en"
proposal_format_version: "2"
translation_of: "proposal.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "ZERO·JZ (Chinese wordmark, literally Zero-Waste Smart Loop; Zero-Waste City Practice Belt & Resource Circularity System) is a zero-waste thematic concept along the Centennial Jingzhang AI Innovation Belt, responding to the low-carbon green innovation environment dimension of the published taskbook. It organizes a resource-circularity network as 'one workshop, one market, one station': the Regeneration Workshop (resource-circularity practice node), the Circular Market (community exchange, repair and reuse ground) and the Zero-Waste Station (community sorting, on-site food-waste treatment and education point). Six personas and 12 AI+ scenario cards (sorting recognition, collection dispatch, material tracing, compost monitoring, carbon-effect tracking, etc.) process anonymized aggregates only, with human review of key decisions and no individual-identifying tracking; three industry test scenarios carry test protocols, failure thresholds and decommissioning rules. Six global reference cases (Shenzhen, Shanghai, Japan, Copenhagen, Singapore, EU) are registered per-item in sources.json. All content is concept-level participatory provisional model data; recompute with the same formulas when official data is published."
...
![ZERO·JZ Logo concept (original vector sketch)](assets/figures/logo.en.png)
...
![AI ecosystem atlas and full-stack resource-circularity system (concept)](assets/figures/ai-ecosystem-map.en.png)
...
![Land-use structure (conceptual shares · not current or statutory)](assets/figures/land-use-structure.en.png)
...
Land use uses the repository-allowed classification codes, covers the provisional overall area completely without gaps, and follows a **single caliber**: geometry/land_use.geojson (EPSG:4548 projection; class area ÷ provisional overall area; low confidence, provisional; re-cut with the same algorithm when the official regulatory plan arrives). Concept shares—research approx. 30.4%, park green approx. 27.1%, business/finance approx. 15.6%, commercial approx. 13.4%, residential approx. 11.1%, cultural approx. 2.3% (approx. 100% after rounding)—are concept model values and **do not represent current or statutory land use**; no FAR, height or scale conclusions are derived from any percentage. The three nodes use indicative combinations of public administration and service, commercial service, and green/facility categories (concept), without changing statutory land-use designations.
...
![Slow-traffic and blue-green network analysis](assets/figures/mobility-bluegreen.en.png)
...
![Core metric evidence (ratio and count charts on separate axes)](assets/figures/metrics-evidence.en.png)
