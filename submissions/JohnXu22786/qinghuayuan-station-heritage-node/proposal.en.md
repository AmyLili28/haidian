---
title: "Qinghuayuan Station · Centennial Jingzhang Cultural Anchor: One-Belt Concept Plan"
...
![Overall design: positions, Three Districts–Two Wings and three nodes (provisional geometry)](assets/figures/site-overview.en.png)

![Land-use and function structure: concept layer, not statutory land-use ratios](assets/figures/land-use-structure.en.png)
...
![Slow mobility, blue-green and public-service interfaces (concept)](assets/figures/mobility-bluegreen.en.png)
...
| [metric:green_space_area_sqm] | 1,393,756.159 sqm | provisional union of concept green polygons |
| [metric:public_space_area_sqm] | 36,150 sqm | provisional union; not an ownership/open-space conclusion |
| [metric:building_footprint_area_sqm] | 111,600 sqm | concept envelope union; not buildable scale |
| [metric:green_ratio] | 0.122122 | green area/site area, six-decimal monitor |
| [metric:public_space_ratio] | 0.003167 | public area/site area, six-decimal monitor |
...
![Metric evidence: geometry monitors, document counts and concept targets (provisional)](assets/figures/metrics-evidence.en.png)
