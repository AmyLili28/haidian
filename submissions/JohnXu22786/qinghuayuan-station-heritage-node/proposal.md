...
summary: "以清华园站为文化锚点，把记忆、体验、创新与治理串成可步行、可共编、可小规模测试、可撤回维护的 AI 文化带；所有空间与外部案例均以 provisional 或核验记录呈现。"
...
| 中智园 AI 自主创新加速区 | 开发者、评估和低风险测试 | API/SDK 概念说明、失败登记、复盘 |
...
![总体结构：三层范围、三区两翼与三处概念节点（provisional）](assets/figures/site-overview.png)

![用地与功能结构：仅为概念图层，不含法定比例](assets/figures/land-use-structure.png)

![重点区域：三处概念节点与 AI 地标（provisional）](assets/figures/key-areas.png)
...
![AI 生态：六域、三区两翼与核验案例队列](assets/figures/eco-map.png)
...
![指标证据：几何监测、包内计数与概念目标分层（provisional）](assets/figures/metrics-evidence.png)
