...
| [metric:landmark_count] | 3 | 概念 GeoJSON 计数 | `scenario_type=ai_landmark`；不等于已建地标 |
| [metric:persona_count] | 5 | 概念画像计数 | 仅用于包容性检查，不是用户统计 |
| [metric:phase_count] | 3 | 概念阶段计数 | P1–P3；时间是研究窗口建议，不是承诺 |
