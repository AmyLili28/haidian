...
**Brand and node naming convention (current review baseline)**: the canonical brand is **ZHILINK CHAIN VALLEY**; **ZC** is only its approved short form for compact labels and is not an independent mark or real-world entity. The three concept nodes are fixed as **知转驿站 / ZC Transfer Post (ZC-TP)**, **金链驿台 / ZC Capital Platform (ZC-CP)** and **慧才驿栈 / ZC Talent Inn (ZC-TI)**. The narrative, matrices, bilingual figures, HTML and A0/A3 boards must use these exact names; unregistered variants such as Zhizhuan Post, JinLian Platform and HuiCai Inn are not used. All names and graphics remain internal working codenames until prior-rights clearance.
...
![Overall Design Overview (provisional geometry, with road/rail/station/district context, scale and north)](assets/figures/site-overview.en.png)

![Conceptual Land-Use Structure (concept shares for illustration only)](assets/figures/land-use-structure.en.png)
...
![Key Areas, Three Districts & the Chain Relays (concept nodes, not official siting)](assets/figures/key-areas.en.png)
...
![Bilingual spatial index: three key areas, three concept relays, road/rail/station context, space types and evidence IDs](assets/figures/spatial-index.en.png)
...
![ZHILINK CHAIN VALLEY · Element-Chain Belt brand identity (concept, internal working codename)](assets/figures/logo-zhilink.en.png)

![Mobility & Blue-Green Analysis (with road/rail/transfer/experience-path context)](assets/figures/mobility-bluegreen.en.png)
...
![Core Metric Evidence (ratios and counts on separate axes; provisional, reduced precision)](assets/figures/metrics-evidence.en.png)
