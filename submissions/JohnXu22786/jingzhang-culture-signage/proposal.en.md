---
title: "ZHANGHEN · JINGZHANG NARRATIVE WAYFINDING BELT (WAYMARK·JZ): Cultural Storytelling Sign System Concept"
...
![Overall overview (concept)](assets/figures/site-overview.en.png)

![Three positionings - five functions - three zones two wings synergy loop (concept)](assets/figures/positioning-functions-zones.en.png)

![Conceptual land-use structure (not existing or statutory)](assets/figures/land-use-structure.en.png)
...
![Storyboard Stop deepening (concept)](assets/figures/node-storyboard-stop.en.png)

![Spike Symbol Trail deepening (concept)](assets/figures/node-spike-trail.en.png)

![Signal Sound Pavilion deepening (concept)](assets/figures/node-signal-pavilion.en.png)
...
![Five personas mapped to AI scenario cards (concept)](assets/figures/persona-ai-map.en.png)
...
![Core metric evidence (counts and ratios plotted separately)](assets/figures/metrics-evidence.en.png)
...
![Brand Logo and VI basics (concept)](assets/figures/logo-jz.en.png)
