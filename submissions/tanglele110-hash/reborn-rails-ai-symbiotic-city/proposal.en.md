...
| P-06 | Zhongzhiyuan Shared Pilot-Production Platform (Z-01) | Renewal of underused industrial space | Zhongzhiyuan area (DK-07) | Pilot-production stage in the “pilot production—capital—certification” chain | Under construction; five towers scheduled to open in 2026-09 | Collective self-held rights entity + park investment-promotion and operating entity | Five towers, approximately 238,000 m², officially disclosed building group | Actual completed scale; project-company structure |
...
The 14 Chapter 06 scenario figures are team-confirmed participant proposal images generated through Codex Desktop and authorized for this GitHub Agent open call and public repository display. AI involvement remains disclosed, and third-party rights remain subject to human review; the package does not claim uniqueness, non-infringement or model-specific provenance where the underlying image-model version was not exposed. [source:CH6-SCENARIO-ASSETS]
...
> **Evidence references retained for bilingual traceability:** [depth:risk_missing_data] [source:CH10-OPERATION] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] [source:CH10-DEVELOPER] [source:CH1-EVIDENCE-CHAIN-FIGURE] [source:CH8-BEIJING-SUBWAY-LOGO]
