---
title: "The Re-coded Crossing: Merging Tracks of Jing-Zhang"
...
summary: "The Jing-Zhang railway heritage spine, Three Zones and Two Wings, and AI Crossings form a recomputable and evolvable AI-symbiotic urban-design proposal within explicitly provisional constraints."
...
## Chapter 01 Design Basis and Source List
...
![Source–claim–space–metric–output evidence chain](assets/figures/chapter01/evidence-chain-zh-v3.en.webp)
...
![Three-level scope framework and three key areas](assets/figures/chapter02/three-level-scope-zh.en.webp)
...
| Level | Content | Role |
|---|---|---|
| Main Chinese Name | **Dao Kou Xin Bian (The Re-coded Crossing)** | Carries forward the historical DNA of Jing-Zhang railway crossings; *xin bian* conveys both re-coding and a new chapter |
...
![Logo Final](assets/figures/chapter03/logo-vi-binary-crossing-zh.png)
...
![Overall viewing effect map for the integrated study](assets/figures/chapter03/overall-research-area-aerial-zh.webp)

> **Figure 3-2 | Panoramic aerial concept of the Coordinated Research Area.** An Agent automatically searched and downloaded public GABLE/OSM/EULUC data to generate the complete K3 Blender urban base; the user then produced the image-to-image rendering on the official GPT website. It conveys overall urban grain and the blue-green setting, and is not an aerial survey, statutory plan, or precise construction proposal. 
...
![Summary of regional structures and innovation synergies](assets/figures/chapter03/regional-structure-ai-crossings-zh.en.webp)

> **Figure 3-3 | Regional structure and innovation-collaboration framework.** Research, overall-design, and key-area extents are provisional; the two wings have no separate official boundary, and OSM is contextual only. [source:CH3-REGIONAL-COLLABORATION] [data:geometry/site_boundary.geojson#SITE-001] [data:geometry/key_areas.geojson]

##### 01 | One Axis, Three Zones, Two Wings, Multiple Crossings

The Jing-Zhang Heritage Park is the innovation axis. Zhongzhiyuan, AI Origin, and Dazhongsi form the three zones; the Zhongguancun Technology-Service Wing and Xiaoyue River Scenario-Empowerment Wing provide professional services and field validation. AI Crossings are distributed interfaces where resources, scenarios, mobility, and public services meet.

##### 02 | Three Positioning Statements

**Table 3-8 | Three Strategic Positions and Their Translation into the Three Track Generations**

| Three Official Positioning Statements | Three-Track Narrative | Functional Translation | Primary Carriers |
|---|---|---|---|
| Centennial Jing-Zhang Cultural Belt | Physical Track (Memory) | Jing-Zhang cultural-heritage and innovation-narrative corridor | Former Tsinghuayuan Station, Juesheng Temple, and the historical narrative route through Jing-Zhang Railway Heritage Park |
| Metropolitan AI Life Experience Belt | Aerial Track (Life) | AI urban-governance and scenario-testing ground | Sidaokou dual-intelligence pilot, AI Origin Community, and the public-scenario network |
| AI Integrated Innovation Belt | Virtual Track (Innovation) | National center of original AI innovation | Zhongzhiyuan full-stack independent innovation, foundation-model origination, and Three Zones and Two Wings collaboration |

The Centennial Jing-Zhang Cultural Belt corresponds to memory; the Metropolitan AI Life Experience Belt to everyday life; and the AI Integrated Innovation Belt to future innovation. They are layered in the same corridor rather than developed as isolated themes.
...
| Continuous Green Space | Use Jing-Zhang Railway Heritage Park as the continuous public framework and Qinghe/Xiaoyue River waterfronts as transverse ecological links, connecting campuses, parks, neighborhoods, and green nodes into a spine–waterfront-corridor–node network | AI Crossings collect environmental sensing, public needs, and maintenance feedback; the Virtual Track recommends time-based opening, activities, ecological maintenance, and extreme-weather response; actions involving flood control, heritage, ecological safety, and public interest require Human Review | Green-space and waterfront continuity, crossing breaks, public-entrance coverage, shade comfort, and avoidance of ecologically sensitive areas, reviewed using formal green-space, river, flood-control, and walking/cycling data |
| Transport–Green-Network Composite Nodes | Prioritize rail stations, park entrances, river crossings, and public interfaces in the Three Zones as composite nodes for interchange, staying, interaction, testing, and emergency conversion | Use a loop of need sensing—option simulation—human authorization—incremental pilot—operational evaluation—expansion or exit | Property rights, passenger flow, flood control, heritage, privacy, safety, and maintenance conditions, added to the implementation candidate list after verification |

The proposal tests a 15-minute/24-hour mixed innovation district, a wall-less innovation commons, a heritage-and-technology narrative corridor, a low-carbon blue-green testing ground, and a human-governed urban-agent network. Each mode remains reversible and subject to housing, noise, accessibility, heritage, ecological, and data-governance constraints.

##### 05 | A High-Quality District for AI Talent

Research, incubation, housing, food, health, learning, recreation, social interaction, and international exchange are organized as one daily ecosystem. Talent targets are planning scenarios, not promises of recruitment or population allocation.

##### 06 | Regional Innovation Collaboration Process

![Regional innovation synergies processes](assets/figures/chapter03/regional-innovation-collaboration-flow-zh.en.webp)

> **Figure 3-4 | Regional innovation collaboration process.** The diagram follows a source–resource–translation–space–feedback evidence-chain logic and distinguishes published baselines from proposed collaboration. [source:CH3-REGIONAL-COLLABORATION-FLOW]

#### 3.2.2 Three-Zone/Two-Wing Loop and AI Crossing Anchors

**Table 3-12 | Industrial Division of Labor and Spatial Orientation of Three Zones and Two Wings**

| Area | Industry Positioning | Core Strategy | Spatial-Design Direction | Main AI Crossing Anchors |
|---|---|---|---|---|
| **Zhongzhiyuan (North)** | AI pilot-production accelerator and future-industry testing ground | Dual university and enterprise anchors; rolling carrier iteration; services provided in advance | Garden-style park, Transit-Station Integration, modular flexible carriers, and early living-support provision | ① `DK-07` Xuezhiyuan Station ② `DK-08` Qinghe Station/former Qinghe station building ③ `DK-10` Qinghuadongluxikou Station ④ Qinghe Hancheng archaeological site–historic Qinghe town |
| **AI Origin Community (Central)** | Foundation-model and core-technology innovation origin | Treat the event ecosystem as innovation infrastructure; low-disturbance organic renewal | Fine-grained block and street-network stitching, dense public space, continuous active ground floors, and permeable university boundaries | ① `DK-05` Wudaokou Station/business district ② `DK-06` Liudaokou–Xueyuan Road ③ `DK-09` Zhichun Road Station ④ Former Tsinghuayuan Station ⑤ Tsinghua Science Park/Beijing Academy of Artificial Intelligence |
...
|---|---|---|---|
| AI Innovation Index [metric:ai_innovation_index] | Six sub-indices: original innovation, commercialization, industry agglomeration, talent vitality, infrastructure/scenario access, and trustworthy governance. After aligning scope, date, and directionality, standardize each component as `Z_k` and calculate `I_AI = Σ(w_k × Z_k)` | No cross-actor dataset with consistent definitions; composite score not currently reported | Components derive from university/research, enterprise, project, talent, computing/data/scenario, and governance records. Determine weights `w_k` after data-completeness testing, peer-area benchmarking, and expert review; weights sum to 1 and cannot replace missing data with subjective scoring |
| Talent Density [metric:site_ai_talent_spatial_density_per_sqkm] [metric:site_ai_employment_share] | Retain both spatial density `D_s = N_AI / A` (persons/km²) and employment-structure density `D_e = N_AI / N_employed × 100%`; count scientists, developers, related students, and general talent separately and deduplicate before aggregation | District-level talent resources approximately 2.0058 million; AI Origin scientists, developers, and related students are reported under separate definitions | Calculate after aligning the AI-talent definition, statistical scope, residence/employment attribute, date, and deduplication rules; recalculate site density after formal boundaries and talent records are available |
| AI Industry Output [metric:haidian_ai_core_industry_output_lower_bound_cny_100m] [metric:site_ai_industry_output_cny_100m] | Record `V_AI` in RMB 100 million and year-on-year growth `g = (V_t − V_(t−1)) / V_(t−1) × 100%` using the official AI core-industry definition; calculate output per industrial-space area `V_AI / A_industry` after verified area data exist | Haidian AI core-industry scale exceeds RMB 350 billion as a district baseline; site-level output and output per industrial-space area are pending | Update after confirming statistical period, industry classification, and spatial attribution; do not conflate with AI market size, enterprise valuation, or district GDP; determine target ranges from trends, carrier capacity, and peer-area benchmarks |
...
![AI Innovation Ecology and Eight Element Resource Flow](assets/figures/chapter03/ai-ecosystem-eight-resources-zh.en.webp)
...
![General space structure map: Axis III, 9th Col., multi-point](assets/figures/site-overview.en.png)
...
![Port anchor distribution](assets/figures/chapter04/crossing-anchor-distribution.en.webp)
...
The one axis is Jing-Zhang Heritage Park; three zones are the mandatory key areas; nine transverse corridors repair east–west links; multiple nodes combine stations, parks, campuses, communities, enterprises, and AI scenarios.

### 4.4 Industrial Functions, Land Use, and Supporting Systems

#### 4.4.1 AI Industry and Enterprise-Agglomeration Targets

The proposal strengthens original innovation, pilot production, application conversion, technology services, and public testing. Enterprise, talent, and output goals are scenario targets; they require a verified T0 register before adoption.

#### 4.4.2 Functional Layout and Flexible Proportions

![General land use and functional structure](assets/figures/land-use-structure.en.png)
...
By floor area, the model uses 55% innovation production (flexible range 50–60%), 30% urban and talent services (25–35%), and 15% public support and New Infrastructure (10–15%). Any implementation scenario must total 100%; range maxima must not be added together.

#### 4.4.3 Overall Building Capacity and Industrial-Space Supply

The scenario tests 16–18 million m² of total floor area, equivalent to an average FAR of about 1.3922–1.5662 on the current provisional 11.4925 km² geometry. This is a carrying-capacity model, not approved floor area or parcel FAR. [metric:chapter04_total_floor_area_model_lower_sqm] [metric:chapter04_total_floor_area_model_upper_sqm]

#### 4.4.4 Transport, Rail, Municipal, and Service Support

![Transport - Blue-Green Public Space Complex System](assets/figures/mobility-bluegreen.en.png)
...
### 4.5 Development Intensity and Urban-Character Control

![Develop intensity partition maps](assets/figures/chapter04/development-intensity.en.webp)

> **Figure 4-5 | Development-intensity zoning.** Relative intensity responds to transit, heritage, ecology, public space, and carrier conditions; no parcel value is represented as a statutory control.
...
Height, massing, coverage, setback, and interface controls remain directional until formal Regulatory Detailed Planning, road, heritage, and engineering conditions are available. [depth:development_intensity_controls]

### 4.6 Overall Urban-Renewal Framework

![Urban update of the general framework chart](assets/figures/chapter04/urban-renewal-framework.en.webp)
...
> **Evidence references retained for bilingual traceability:** [source:OFFICIAL-ANNOUNCEMENT] [source:CH3-HAIDIAN-AI-BASELINE] [source:CH4-V9-DESIGN-BASELINE] [source:CH4-V9-DESIGN-BASELINE] [metric:chapter04_reported_reusable_space_sqm] [source:CH4-V9-DESIGN-BASELINE] [standard:MOHURD-URBAN-DESIGN-MEASURES] [depth:overall_spatial_structure] [data:geometry/key_areas.geojson#PROV-KEY-001] [data:geometry/key_areas.geojson#PROV-KEY-002] [data:geometry/key_areas.geojson#PROV-KEY-003] [metric:chapter04_crossing_anchor_count] [data:geometry/roads.geojson#ROAD-JZ-AXIS] [source:CH4-V9-DESIGN-BASELINE] [source:CH3-HAIDIAN-AI-BASELINE] [metric:chapter04_innovation_production_share] [metric:chapter04_city_service_share] [metric:chapter04_public_support_share] [metric:chapter04_reported_industry_space_sqm] [metric:chapter04_reported_reusable_space_sqm] [metric:chapter04_total_floor_area_model_lower_sqm] [metric:chapter04_total_floor_area_model_upper_sqm] [metric:chapter04_average_intensity_model_lower] [metric:chapter04_average_intensity_model_upper] [metric:building_footprint_area_sqm] [data:geometry/roads.geojson] [depth:traffic_rail_slow_parking] [depth:municipal_new_infrastructure] [source:OFFICIAL-ANNOUNCEMENT] [data:geometry/public_space.geojson#PUBLIC-001] [source:CH4-V9-DESIGN-BASELINE] [standard:MOHURD-URBAN-DESIGN-MEASURES] [depth:height_massing_character] [source:CH4-V9-DESIGN-BASELINE] [metric:chapter04_reported_reusable_space_sqm] [source:CH10-PROJECT-INTERFACE] [metric:renewal_project_count] [depth:renewal_project_list] [data:geometry/phasing.geojson#PHASE-001] [source:CH10-PROJECT-INTERFACE]
...
![Three highlights index and design task maps](assets/figures/key-areas.en.png)
...
| Z-02 Xuezhiyuan Station-City Integration | Mixed use of station-level ground floors; no large-volume new construction | 28,000–36,000 m² | 0–1,000 m² | Retain main buildings; renew entrances, canopies, and accessible interfaces; trigger under near-term pilot conditions |
...
![Section 3 implements depth nodes and profile control](assets/figures/chapter05/a-05-05-implementation-depth-final.en.png)

> **Figure 5-2 | Implementation depth, key nodes, and section controls.** Three nodes, three sections, and three interface connections define the present competition-level design depth and professional follow-up gates.

### 5.2 Zhongzhiyuan AI Independent Innovation Acceleration Area

#### 5.2.1 Design Goal and Core Issues

Create a garden-like full-stack innovation district linking shared pilot production, standards and safety governance, low-carbon exchange, Qinghe ecology, transit access, and everyday services.

#### 5.2.2 Spatial Structure and Priority Actions

![Comprehensive detailed design of the park of mind key area](assets/figures/chapter05/a-05-02-zhongzhiyuan-detailed-design.en.webp)

> **Figure 5-3 | Zhongzhiyuan key-area detailed design.** It presents the industry and project chain, building-renewal directions, station–district and slow-mobility links, blue-green public space, and implementation risks. The boundary is provisional; project nodes are design recommendations shown at indicative locations.

![The concept of the garden-based AI Innovation Block is a visual.](assets/figures/chapter05/a-05-02a-zhongzhiyuan-aerial-concept.webp)
...
![Zhongzhiyuan shared pilot-production platform and public observation interface](assets/figures/chapter06/lm-01-ai-co-testing-lighthouse.webp)
...
![Zhongzhiyuan Xuezhiyuan station–district integration section](assets/figures/chapter05/ch05-scene-03-dazhongsi-culture-interface.webp)

> **Figure 5-6 | Zhongzhiyuan Xuezhiyuan station–district integration section.** Corresponding to Z-02, it presents the combined relationship among rail access, commercial services, and the district ground floor. This AI-assisted image is conceptual; underground space, structure, and engineering conditions require specialist verification.
...
![Comprehensive detailed design of the priority areas of the communities in the AAI Origin Beijing](assets/figures/chapter05/a-05-03-ai-origin-community-detailed-design.en.webp)

> **Figure 5-7 | Beijing AI Origin Community key-area detailed design.** It presents the innovation-transfer network, low-disturbance renewal, continuous pedestrian frontage, station links, and public space. The boundary is provisional; project nodes are design recommendations shown at indicative locations.

![Beijing AI Origin Community Concept](assets/figures/chapter05/a-05-03a-ai-origin-community-aerial-concept.webp)
...
![AI Origin Community Wudaokou and central Jing-Zhang Park activity scene](assets/figures/chapter05/ch05-scene-05-origin-campus-crossing.webp)
...
![AI Origin Community urban innovation public living room](assets/figures/chapter05/ch05-scene-07-ai-origin-urban-innovation-living-room.webp)
...
![Comprehensive detailed design of the Dazhongsi priority area](assets/figures/chapter05/a-05-04-dazhongsi-detailed-design.en.webp)

> **Figure 5-12 | Dazhongsi key-area detailed design.** It presents culture-led renewal, classified adaptive reuse, four-quadrant stitching, station–district links, and public interfaces for AI applications. The boundary is provisional; project nodes are design recommendations shown at indicative locations.

![The concept of the A.I. Industrial conglomerate at Dazhongsi](assets/figures/chapter05/a-05-04a-dazhongsi-aerial-concept.webp)
...
![Dazhongsi four-quadrant stitching and dual-intelligence experience segment](assets/figures/chapter05/ch05-scene-01-zhongzhiyuan-pilot-interface.webp)

> **Figure 5-15 | Dazhongsi four-quadrant stitching / dual-intelligence experience segment.** Corresponding to D-02 / D-04, it presents walking and cycling links among the station and the four quadrants of the North Third Ring Road, plus replaceable smart-mobility and smart-service facilities. This AI-assisted image is conceptual; underground works, road traffic, and equipment deployment require specialist review.

![Dazhongsi station forecourt](assets/figures/chapter05/ch05-scene-08-dazhongsi-station-plaza.webp)
...
The design addresses leading enterprises, agents, intelligent terminals, content consumption, data elements, digital assets, commercial services, mixed use of planned green space, Dazhongsi Station, and four-quadrant connectivity.
...
![The rhythm of the day for the five categories of users](assets/figures/chapter06/fig-6-2-persona-daily-rhythm-zh.en.webp)
...
| SC-03 | Human-AI Collaboration and Prototype Validation Workshop; R&D and start-up teams | DK-07 Xuezhiyuan entrance / restricted pilot-production interface in Zhongzhiyuan | Status sensing—process recommendation—staff approval—restricted testing—shutdown/removal; planned test |
...
![SC-01AI Innovation Room](assets/figures/chapter06/sc-01-ai-innovation-living-room-zh.en.webp)

> **Figure 6-3 | SC-01 AI Innovation Living Room.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-02AI Educational and Scientific Collaboration Station](assets/figures/chapter06/sc-02-education-research-collaboration-zh.en.webp)

> **Figure 6-4 | SC-02 AI Education and Research Collaboration Station.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-03Humans Collaboration and Prototype Certification Workshop](assets/figures/chapter06/sc-03-human-ai-prototype-workshop-zh.en.webp)

> **Figure 6-5 | SC-03 Human–AI Prototyping Workshop.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-04Public Computing power Service Window](assets/figures/chapter06/sc-04-public-compute-service-zh.en.webp)

> **Figure 6-6 | SC-04 Public Compute Service Window.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-05Community health co-ordination stations](assets/figures/chapter06/sc-05-community-health-coordination-zh.en.webp)

> **Figure 6-7 | SC-05 Community Health Coordination Station.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-06AI Community Service Workstation](assets/figures/chapter06/sc-06-ai-community-service-station-zh.en.webp)

> **Figure 6-8 | SC-06 AI Community Service Station.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-07Four-bit smart traffic test.](assets/figures/chapter06/sc-07-sidaokou-traffic-coordination-zh.en.webp)

> **Figure 6-9 | SC-07 Sidaokou Intelligent-Transport Coordination Test.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.

Tests signal and mobility coordination in a controlled area; traffic authorities approve plans and the system reverts to the existing scheme on failure.

#### 6.3.8 SC-08 Xiaoyue River Embodied-AI Public-Space Test

![SC-08Xiaoyue River's Intelligent Public Space Test](assets/figures/chapter06/sc-08-xiaoyuehe-embodied-ai-test-zh.en.webp)

> **Figure 6-10 | SC-08 Xiaoyue River Embodied-AI Public-Space Test.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-09Ecoperception and Waterfront Warning Station, Xiaoyue River](assets/figures/chapter06/sc-09-xiaoyuehe-eco-sensing-zh.en.webp)

> **Figure 6-11 | SC-09 Xiaoyue River Ecological Sensing and Waterfront Warning Station.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-10The Jing-Zhang Railway Memory Review](assets/figures/chapter06/sc-10-jingzhang-memory-guide-zh.en.webp)

> **Figure 6-12 | SC-10 Jing-Zhang Railway Memory Guide.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.

Provides traceable interpretation with historian and heritage review; generative content cannot rewrite historical facts.

#### 6.3.11 SC-11 Zhongguancun Innovation Oral-History Co-creation Station

![SC-11China-Komura Innovative History Co-founder](assets/figures/chapter06/sc-11-zhongguancun-oral-history-zh.en.webp)

> **Figure 6-13 | SC-11 Zhongguancun Innovation Oral-History Co-creation Station.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![SC-12AI Public Office of the New Culture](assets/figures/chapter06/sc-12-ai-culture-forum-zh.en.webp)

> **Figure 6-14 | SC-12 AI New-Culture Public Forum.** This AI-assisted proposal scenario card is conceptual only; it is not evidence of existing conditions, a completed or approved project, or actual operation.
...
![The "AI test lighthouse" shared by the Mensitor Park is an experiment with public viewing.](assets/figures/chapter06/lm-01-ai-co-testing-lighthouse.webp)
...
![The AI Origin "Open Source Co-Specific Map" opens the scene of public events.](assets/figures/chapter06/lm-02-open-source-co-creation-star-map.webp)
...
![The history of the Dazhongsi, the "Ancient Symphony Portal" and the public service scene](assets/figures/chapter06/lm-03-ancient-future-resonance-gateway.webp)
...
|Manual finalization and takeover|Medical, transport, safety, historical content, public services and public issues are judged by the clearly identified human duty bearers.|Closed/resuspensive if no responsible person can be identified or cannot take over|
...
![Map of the land use and space structure](assets/figures/land-use-structure.en.png)
...
![Dismantling classification and spatial object direction chart](assets/figures/chapter07/retain-renovate-demolish-direction.en.webp)
...
![Traffic walking and cycling, orbital access, blue-green public space and AI node complex system](assets/figures/mobility-bluegreen.en.png)
...
|---|---|---|---|---|
|`site_area_sqm`|**known / low confidence**|11,492,502.430㎡|`polygon_area(site_boundary)`|Redistribution of official borders after replacement|
|`green_ratio`|**known / low confidence**|13.505068%|`polygon_area(green_space) / polygon_area(site_boundary)`|Recount after greenfield and official border|
|`public_space_ratio`|**known / low confidence**|4.368577%|`polygon_area(public_space) / polygon_area(site_boundary)`|Recalculation of public spaces and official borders after replacement|
...
> This is a conceptual register, not an approved implementation plan. Any status, date, investment or scale without an individually registered direct official URL, publisher, title and date is downgraded to a research lead and may not be cited as a confirmed fact, budget or schedule.
...
|---|---|---|---|---|---|---|---|---|
| P-01 | Jing-Zhang Railway Heritage Park vitality-corridor connection and environmental improvement | Heritage conservation and environmental improvement | Along Jing-Zhang Railway Heritage Park, from Qinghe in the north to Xizhimen in the south | Continuous blue-green spine, cultural narrative, and connected public space | Opening status is a research lead pending a direct official source | Park construction/management entity + operating entity, pending formal confirmation | RMB 162 million / approximately RMB 200 million are research leads, not a budget basis | Opening phases, operating model, operating rights, and public-access responsibilities |
...
| P-03 | Zhongkun Plaza in-depth commercial-to-office conversion | Functional conversion of existing buildings | Dazhongsi area | Convert an underused commercial building into an industrial-headquarters carrier | Acquisition and renewal status are media research leads | State-owned transferred/self-held rights entity + professional existing-building renewal team | Approximately RMB 9 billion is a media lead, not a budget basis | Transaction and renewal status; post-renewal uses and scale; structural testing |
| P-04 | Lanjing Lijia acquisition–transfer–self-held redevelopment | Renewal of underused industrial space | Dazhongsi area | Use a precedent involving social-capital land supply and municipal indicator support | Investment and schedule are research leads pending a direct official source | Acquisition/transfer implementation entity + self-held operating entity | RMB 2.8 billion / 20-year self-holding are research leads, not a budget basis | Municipal-indicator conditions, property rights, investment and completion schedule |
| P-05 | Tencent Xueyuan Road New Headquarters, including public interfaces | Renewal of underused industrial space / potential new construction | Northern Zhongzhiyuan area | New enterprise-core carrier with integrated connections to a rail micro-center | Construction status and 2025 start are research leads pending verification | State-owned transferred/self-held rights entity + park operator | RMB 6.42 billion is a research lead, not a budget basis | Construction status, completion scale and phasing; public-interface arrangements |
| P-06 | Zhongzhiyuan Shared Pilot-Production Platform (Z-01) | Renewal of underused industrial space | Zhongzhiyuan area (DK-07) | Pilot-production stage in the “pilot production—capital—certification” chain | Construction status and 2026-09 opening are research leads pending verification | Collective self-held rights entity + park investment-promotion and operating entity | Approximately 238,000 m² is a research lead, not an approved scale | Actual construction/opening status, scale and project-company structure |
...
| P-08 | Dazhongsi culture-led interface and four-quadrant stitching (D-03/D-04) | Public-space and walking/cycling stitching | Dazhongsi area (DK-04) | Juesheng Temple–Dazhongsi 1733 cultural interface and four-quadrant walking connection | Current proposal; Sidaokou pilot status is an unverified research lead | State-owned transferred/self-held rights entity + professional existing-building renewal team + public-cultural operator | Cost pending professional estimate | Pilot status; four-quadrant engineering approvals involving rail and the Third Ring Road; heritage and development controls |
| P-09 | Xiaoyue River cross-boundary waterfront-facility maintenance-agreement pilot | Public-space and walking/cycling stitching | Along Xiaoyue River in East Wing E1 | Resolve waterfront public-space maintenance seams between water and landscape authorities | Under-construction status and 6.41 km are research leads pending a direct official source | Water-construction management entity + landscape maintenance entity | Investment is unverified and not a budget basis | Construction status, scale, takeover entity and funding channel |
...
![Phasing Logic: Evidence Maturity, Not Calendar Order](assets/figures/chapter10/phasing-three-stage-logic-zh.en.webp)
...
|State-owned concession land (Cold Temple model)|The Blue Fairy's "Repository-Sending-Twenty Years" $2.8 billion, the first social capital to be found in Haidian.|**Deposits**(offer conditions can be included in public opening obligations)|Dispersing small ownership rights is the biggest obstacle to renewal (the Chinese lesson); public interface negotiation space is giving in|
...
![Annual Activity System: Jing-Zhang Future Tracks Four-Tier Rhythm](assets/figures/chapter10/annual-events-four-tier-rhythm-zh.en.webp)

> **Figure 10-3 | Annual Activity System: Jing-Zhang Future Tracks Four-Tier Rhythm.** Everyday access, monthly co-creation, quarterly linkage, and annual review form a long-term operating proposal. Event names, frequencies, and lead categories are design mechanisms, not confirmed government events or fixed arrangements. [source:CH10-FIGURE-ASSETS] [source:CH10-EVENTS]

Annual AI events, open-source releases, developer days, heritage walks, public test days, and international roadshows form a layered calendar rather than a permanent occupation of public space.

#### 10.4.2 Spatial Support and Directed Rules

Every activity identifies venue capacity, accessibility, noise, fire safety, crowd management, data use, rights, cleaning, restoration, and cancellation conditions.

#### 10.4.3 Public Experience and Landmark Operation

The three landmarks and public route support everyday use first and programmed events second; ordinary passage and non-digital participation remain available.

### 10.5 Developer Community and Scenario-Access Operation

#### 10.5.1 Developer-Community Mechanism

Open calls, documentation, mentoring, testing, attribution, and public feedback support developers while protecting research, personal, and infrastructure data.

#### 10.5.2 Scenario-Access Mechanism

Scenarios are released with scope, data, site, safety, operator, evaluation, and exit requirements; approval remains with authorized humans and institutions.
...
|Green space|1,552,070.246㎡;13.505068%|From the same general border with`green_space.geojson`Recovered low-confidence design model values|
|Public space|502,058.763㎡;4.368577%|From the same general border with`public_space.geojson`Recovered low-confidence design model values|
...
|---|---:|---:|---:|---|
|AI Effective Corporate Aggregation Index`E/E0×100`|≥110|≥125|≥140|Only the main body of the verifiable office, research and development, intermediate test, service or operation is counted in the site; registration addresses cannot be counted separately|
|AI human space density index`D/D0×100`|≥108|≥120|≥130|Disaggregated by scientists, developers, relevant students and other talent; synchronized verification of housing, commuting, public services and innovative communication carrying|
|Site AI industrial output index`V/V0×100`|≥115|≥140|≥170|Fixed industry classification, statistical cycle and spatial attribution; not to be commingled into enterprise valuation, market size or sector-level output that cannot be attributed to the site|
...
|---|---:|---:|---:|---|
|Overall design scope|11,400,000㎡|11,492,502.43㎡|+0.81%|Published brief as task scale; geometry is the temporary model denominator|
|Total three key areas|3,684,000㎡|3,687,872.19㎡|+0.11%|Approaching the announcement is not proof of the boundary.|
|Zhongzhiyuan|1,921,000㎡|1,918,001.919㎡|-0.16%|Retain the provisional-data label|
|Beijing AI Origin Community|1,043,000㎡|1,046,952.810㎡|+0.38%|Retain the provisional-data label|
|Dazhongsi|720,000㎡|722,917.464㎡|+0.41%|Retain the provisional-data label|
...
![Core indicator recalculation and mission evidence chain](assets/figures/metrics-evidence.en.png)
...
|Copyright and public compliance|The power status to generate maps, third-party data, fonts, logos, portraits and historical materials is not the same|Unliquidated assets may not be publicly submitted; concept maps may not be assumed to be live, measured, statutory or approved results|Substitute, withdraw or discontinue distribution of rights if insufficient evidence exists|Asset makers, collusive authors and intellectual property professionals|
...
The 14 Chapter 06 scenario figures were generated on 2026-08-25 through direct Codex Desktop calls to its built-in `image_gen` capability, with some per-image review continuing on August 26. Per-file hashes, generation method, task record, applicable OpenAI terms, and the participant's 2026-08-31 authorization for public-repository display and redistribution are registered. The interface did not expose the underlying image-model version, so the package makes no claim of model-level provenance, uniqueness, or absolute non-infringement. [source:CH6-SCENARIO-ASSETS] [source:OPENAI-TERMS-2026-01-01]

The former Beijing Subway simplified mark had a Wikimedia PD-shape copyright designation, but no operator-issued trademark permission for this public display was located. It has therefore been removed from both Chinese and English mobility figures and replaced with an original neutral station-node symbol. [source:CH8-BEIJING-SUBWAY-LOGO] [source:CH8-NEUTRAL-STATION-SYMBOL]

This document is a competition-oriented conceptual recommendation. It does not replace statutory planning, surveying, ownership confirmation, administrative approval, professional design, or government implementation. Chinese and English narrative, drawings, HTML, and text-bearing figures must remain equivalent; offline outputs may not load remote scripts, tiles, fonts, images, iframes, forms, APIs, or trackers.

> **Evidence references retained for bilingual traceability:** [depth:risk_missing_data] [source:CH10-OPERATION] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] [source:CH10-DEVELOPER] [source:CH1-EVIDENCE-CHAIN-FIGURE] [source:CH8-BEIJING-SUBWAY-LOGO] [source:CH8-NEUTRAL-STATION-SYMBOL]
...
### 13.2 Structured Sources and Rights Records

Publishers, URLs or local paths, access dates, licenses, uses, and limits are retained in `sources.json`. `metrics.json`, `compliance_matrix.json`, `standard_matrix.json`, and `design_depth_matrix.json` retain formulas, spatial references, professional standards, task coverage, and depth. Image, font, Logo, generated-asset, and media rights are governed by `report/copyright_statement.md`; material without completed rights review may not enter the public submission.
