...
summary: "A public connection line along the historic Jing-Zhang Railway brings knowledge, people, enterprise, compute, capital, data and daily life together across the Three Zones and Two Wings."
...
![Scope, Three Zones and Two Wings, and the connection line](assets/figures/site-overview.en.png)
...
![The three key areas and human journeys](assets/figures/key-areas.en.png)
...
![Mobility, blue-green space and city rooms](assets/figures/mobility-bluegreen.en.png)
...
![Evidence chain from metrics to review](assets/figures/metrics-evidence.en.png)
