...
人才画像不止于开发者。检索 119 份公开提案可见，人才相关表述出现率 **100%**，而既有居民中位提及次数为 **1**、可负担性相关表述出现率约 **16%**，其中 21 份从未提及既有居民。本方案据此在 8 组画像中留出 **5 组（62.5%）**给非人才人群（P-04 至 P-08），属**概念建议**。
